...
export default function TopPanel({ openWindows = [], onOpenWindow, onTaskbarClick, activeWindowId }: TopPanelProps) {
  ...
  const appLaunchers = [
    { id: "files",    icon: <FolderOpen size={14} color="#a8c4f5" />, title: "File Manager" },
    { id: "firefox",  icon: <SiFirefox size={13} color="#ff6611" />,  title: "Firefox",
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center h-full gap-0">
        {/* Logo / App Menu */}
        <div className={btnClass} style={{ paddingLeft: 10, paddingRight: 10 }} title="Applications">
          <KaliDragonIcon />
        </div>
      ...
      <div className="flex items-center h-full" ref={trayRef}>
        ...
        >
          ...
          {showCalendar && (
            <div
              style={{
                position: "fixed", bottom: 38, right: 70,
