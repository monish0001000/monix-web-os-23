...
export default function WindowChrome({
  ...
  const isMaxed = maximized || isMobile;
          ...
          >
            ...
            {!isMobile && (
              ...
              >
                <Minus
                  size={9}
                  color={hoverBtn === "min" ? "#ffd080" : "#d0d0d0"}
                  strokeWidth={2.5}
                />
              </button>
            )}
            ...
            {!isMobile && (
              ...
              >
                <Square
                  size={8}
                  color={hoverBtn === "max" ? "#80e080" : "#d0d0d0"}
                  strokeWidth={2}
                />
              </button>
            )}
