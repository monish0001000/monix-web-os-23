...
import { generateChatResponse, ChatOptions } from './geminiService';
          ...
          <div className="p-3 border-t border-gray-200 bg-white">
            ...
            <form onSubmit={handleSubmit} className="relative flex items-end gap-2 bg-gray-50 rounded-2xl border border-gray-200 p-1 focus-within:border-blue-400 focus-within:ring-1 focus-within:ring-blue-400 transition-all">
              ...
              <textarea
                ...
                className="flex-1 max-h-32 min-h-[20px] py-2.5 bg-transparent outline-none resize-none text-sm text-gray-800 placeholder-gray-500 overflow-y-auto"
                rows={1}
              />
